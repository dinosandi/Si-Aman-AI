...
define(['./workbox-5d155c7a'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.cn1giumssg4"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/[a-c]\.tile\.openstreetmap\.org\/.*$/, new workbox.CacheFirst({
    "cacheName": "osm-tiles",
  ...
  workbox.registerRoute(/\/api\/v1\/(routes\/safe|reports\/crowdsource|zones\/risk)/, new workbox.NetworkFirst({
